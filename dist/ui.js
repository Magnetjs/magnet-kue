...
class KueUI extends _base2.default {
  setup() {
    var _this = this;

    return _asyncToGenerator(function* () {
      const config = Object.assign(_kue4.default, _this.config.kue, _this.options);

      if (!config.ui) return;

      const app = (0, _express2.default)(config.ui.express);
      ...
      app.listen(config.ui.listen, function () {
        _this.log.info(`Kue UI server started at port ${config.ui.listen}`);
      });
    })();
  }
}
